...
def test_repr(request_get, playlist_html):
    ...
    assert (
            repr(playlist) == '[<pytube.__main__.YouTube object: videoId=ujTCoH21GlA>, '
                              '<pytube.__main__.YouTube object: videoId=45ryDIPHdGg>, '
                              '<pytube.__main__.YouTube object: videoId=1BYu65vLKdA>, '
                              '<pytube.__main__.YouTube object: videoId=3AQ_74xrch8>, '
                              '<pytube.__main__.YouTube object: videoId=ddqQUz9mZaM>, '
                              '<pytube.__main__.YouTube object: videoId=vwLT6bZrHEE>, '
                              '<pytube.__main__.YouTube object: videoId=TQKI0KE-JYY>, '
                              '<pytube.__main__.YouTube object: videoId=dNBvQ38MlT8>, '
                              '<pytube.__main__.YouTube object: videoId=JHxyrMgOUWI>, '
                              '<pytube.__main__.YouTube object: videoId=l2I8NycJMCY>, '
                              '<pytube.__main__.YouTube object: videoId=g1Zbuk1gAfk>, '
                              '<pytube.__main__.YouTube object: videoId=zixd-si9Q-o>]'
    )
    request_get.assert_called()
